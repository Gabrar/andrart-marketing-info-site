    ...
    <div className="relative min-h-dvh w-full bg-black p-2 px-2 text-white ">
      <section className="">
        ...
        <main className="py-5 flex m-6 lg:flex-row items-center bg-gra">
          <div className="flex flex-col lg:w-full font-montserrat justify-center mb-auto xl:text-7xl xl:mb-auto lg:text-5xl md:text-4xl md:mb-auto lg:mb-auto xl:m-6 animate-fade-in">
            <span className="tracking-widest animate-right">
              Agência <span className="text-[#e37035]">criativa </span> <br />e estratégica
            </span>
            
            <span className="tracking-widest text-xs xl:text-3xl lg:text-2xl md:text-base animate-right">
              Para quem quer ser <br className="xl:hidden lg:hidden md:hidden" />lembrado e ser visto.
            </span>

            <div className="hidden lg:block w-full md:max-w-4xl lg:max-w-3xl mt-12">
              <InfitieCarousel />
            </div>

            <div className="block lg:hidden mr-4"> 
              <button className="text-xs bg-linear-to-r from-[#c73433] to-[#f3a73a] rounded-lg p-2 text-white whitespace-nowrap my-10 animate-right">
                ENTRE EM CONTATO
              </button>
            </div>
